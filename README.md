...
Published on Packagist as **[`imarc/fort`](https://packagist.org/packages/imarc/fort)**.
...
### Local or monorepo development

If you vendor or symlink the package inside your app repo instead of using Packagist, add a **path** repository (never edit code under `vendor/` as your source of truth—it is regenerated by Composer):
